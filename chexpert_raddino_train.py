# chexpert_raddino_train.py
# AyShCXR — CheXpert Plus training. Rad-DINO transformer (3-channel, 224px, CLS token),
# Focal + LLRD, fast 18-epoch high-LR, patient-level split. shm-safe loaders.
#   python chexpert_raddino_train.py
...
ARCH       = "rad_dino"               # <-- only line that differs across the 3 files
